 ...
 * @author THIYANESH S
 */
@WebServlet(urlPatterns = {"/powerbank"})
public class powerbank extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet powerbank</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet powerbank at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Item[] items = d.checkpass("powerbank");
        response.setContentType("text/html;charset=UTF-8");
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
            out.println("<!DOCTYPE html>");
...
"                <a href=\"\\WebApplication5\\headset\">Headset</a>\n" +
"                <a class=\"active\" href=\"\\WebApplication5\\powerbank\">Power Bank</a>\n" +
"            </div>");
